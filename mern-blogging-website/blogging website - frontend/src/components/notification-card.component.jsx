...
const NotificationCard = ({ data, index, notificationState }) => {
    ...
    return (
        <div className={"p-6 border-b border-grey border-1-black" + (!seen ? "border-1-2" : "")}>
            ...
            <div className="ml-14 pl-5 mt-3 text-dark-grey flex gap-8"></div>
            ...
            }
            {
                reply ?
                    <div className="ml-20 p-5 bg-grey mt-5 rounded-md">
                        ...
                        <p classname="ml-14 font-galesio text-xl my-2">{reply.comment}</p>

                        <button className="underline hover:text-black mt-2 ml-14" onClick={(e)=> handleDelete(reply._id, "reply", e.target)}>Delete</button>
                    </div> : ""
