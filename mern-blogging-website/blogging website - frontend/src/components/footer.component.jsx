...
const Footer = ({ instagramImages, recentComments, categories }) => {
  ...
  return (
    <div className="w-full pt-4 pb-0 px-2 sm:px-6 md:px-10">
        ...
        <div className="flex flex-col md:flex-row gap-4 w-full">
          <div className="flex-1 w-full md:w-1/2 sm:max-w-xs bg-gray-200 rounded-3xl p-4 flex flex-col gap-2 shadow-md mb-4 md:mb-0">
            ...
            <div className="flex flex-col gap-2">
              {comments.map((c, idx) => (
                <div key={idx} className="bg-white rounded-lg p-1.5 text-xs sm:text-sm shadow-sm min-h-0">
                  <span className="font-semibold text-gray-700 block leading-tight mb-0.5">{c.commented_by?.personal_info?.fullname || c.commented_by?.fullname || "User"}</span>
